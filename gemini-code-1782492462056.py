...
<body>
    <div class="container">
        ...
        <h1>يا ياسمين، ممكن بوسة؟<br><br><span style="font-size: 0.6em; color: #ff3366;">- حبيبك يوسف</span></h1>
        <div class="hearts">💞 💓 💞 💓 💞 💓 💞</div>
        
        <div class="buttons-area" id="area">
            <!-- لما توافق، الشاشة كلها هتتغير للرسالة دي -->
            <button id="btn-yes" class="btn" onclick="document.body.innerHTML='<h1 style=\\'color:#cc0000; margin-top: 35vh; text-align:center;\\'>وأنا بموت فيكي يا ياسمين! ❤️<br><br>- يوسف</h1>'">أكيد ❤️</button>
